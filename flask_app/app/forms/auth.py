...
class UserForm(FlaskForm):
    ...
    payment_status = SelectField("Payment Status", choices=[("paid", "Paid"), ("pending", "Pending"), ("failed", "Failed")], validators=[Optional()])
    subscription_plan = StringField("Subscription Plan", validators=[Optional(), Length(max=50)])
    submit = SubmitField("Save")
